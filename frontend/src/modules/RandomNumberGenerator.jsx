...
const RandomNumberGenerator = () => {
  ...
  return (
    <div className="min-h-screen">
      <title>Генератор чисел - Полезные инструменты - use-tools.ru</title>
      <meta
        name="description"
        content="Поможет сгенерировать числа например для участия в лотерее"
      />
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-blue-100 h-full">
              <div className="flex justify-between items-center mb-6 pb-3 border-b border-blue-100">
                ...
                <button
                  ...
                  className="max-md:hidden bg-linear-to-r cursor-pointer from-blue-500 to-teal-500 text-white px-4 py-2 rounded-lg hover:from-blue-600 hover:to-teal-600 transition-all flex items-center shadow-md hover:shadow-lg"
                >
                  <svg
              ...
              <div className="mb-8">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {numbers.map((number, index) => (
                    ...
                    >
                      <div className="text-xs text-blue-300 mb-1 cursor-default">
                        №{index + 1}
                      </div>
