      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-gray-800 text-sm mt-16">
          <details className="group">
            ...
            <div className="overflow-hidden transition-all duration-500 ease-in-out max-h-0 group-open:max-h-[2500px]">
              <div className="p-4 pt-6">
                <p className="font-bold mt-6 text-center">
                  🚗 Генератор Договора Купли-Продажи Автомобиля | Создать ДКП
                  на Авто Онлайн Бесплатно
                </p>

                <p className="mt-6">
                  <strong>
                    Онлайн генератор договора купли-продажи автомобиля
                  </strong>{" "}
                  — это профессиональный инструмент для быстрого и безопасного
                  оформления сделки по продаже или покупке транспортного
                  средства. Наш <strong>бесплатный генератор ДКП</strong>{" "}
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Генератор ДКП автомобиля</strong> — создание
                      договора купли-продажи для легковых и грузовых автомобилей
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      Мгновенное создание договора без регистрации и
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>
                        Договор купли-продажи авто онлайн бесплатно
                      </strong>{" "}
                  ...
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Генератор для покупателя и продавца</strong> —
                      создание договора с обеих сторон сделки
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Генератор на компьютере</strong> — работает прямо
                ...
                <p className="mt-6 font-bold">
                  Почему выбирают наш генератор ДКП:
                </p>
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
                  <li className="flex items-start">
                    <span className="mr-2">✓</span>
                    <span>
                      <strong>Юридическая надежность.</strong> Договор
                      составляется по актуальным шаблонам с учетом судебной
                      практики
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Актуальные требования.</strong> Учет последних
                      изменений в законодательстве о регистрации ТС
                    </span>
                  </li>
                </ul>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
                  <li className="flex items-start">
                    <span className="mr-2">✓</span>
                    <span>
                      <strong>Паспортные данные сторон</strong> — полная
                  ...
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Реквизиты ПТС и СТС</strong> — серии и номера
                  ...
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Стоимость сделки</strong> — прописью и цифрами,
                      условия расчета
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Состояние автомобиля</strong> — описание
                      технического состояния на момент продажи
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Подписи сторон</strong> — места для подписей
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
                  ...
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                    <span>
                      <strong>Покупка авто с рук.</strong> Защита прав
                      покупателя при приобретении подержанного автомобиля
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className=" mr-2">✓</span>
                ...
                <p className="mt-4">
                  ...
                  (наличный/безналичный), включить условие о{" "}
                  <strong>задатке</strong> или{" "}
                  <strong>рассрочке платежа</strong>, а также добавить{" "}
                  <strong>дополнительные соглашения</strong>. Договор содержит
                  все необходимые разделы для регистрации в ГИБДД.
                </p>

                <p className="mt-6">
                  <strong>Бесплатный онлайн генератор ДКП автомобиля</strong> —
                  это ваша юридическая защита при сделке с авто! Попробуйте наш{" "}
                  <strong>
                    инструмент для создания договора купли-продажи
                  </strong>{" "}
                  прямо сейчас — это лучший способ обезопасить сделку, избежать
                  мошенничества и правильно оформить переход права
                  собственности. <strong>Профессиональный генератор</strong> для
                  безопасной покупки и продажи автомобилей!
                </p>

                <p className="mt-6">
                  Популярные запросы: договор купли продажи автомобиля, ДКП
                  авто, генератор ДКП, договор купли продажи авто, скачать
                  договор купли продажи автомобиля, бланк ДКП, договор купли
                  продажи машины, образец договора купли продажи автомобиля,
                  договор купли продажи транспортного средства, оформить ДКП
                  онлайн
                </p>
              </div>
            </div>
